...
export const sceneComponents = Object.freeze({
  ...
  'city-gatineau': lazy(() => import('./sceneEntries/CityGatineauEntry.jsx')),
  'frida-coyoacan': lazy(() => import('./sceneEntries/FridaCoyoacanEntry.jsx')),
  'textile-bonwire': lazy(() => import('./sceneEntries/TextileBonwireEntry.jsx')),
  'zellige-fes': lazy(() => import('./sceneEntries/ZelligeFesEntry.jsx')),
  'swell-marshall': lazy(() => import('./sceneEntries/SwellMarshallEntry.jsx')),
  'siku-bolivia': lazy(() => import('./sceneEntries/SikuBoliviaEntry.jsx')),
  'metate-teotitlan': lazy(() => import('./sceneEntries/MetateTeotitlanEntry.jsx')),
  'tongiaki-tonga': lazy(() => import('./sceneEntries/TongiakiTongaEntry.jsx')),
  'garamut-sepik-ramu': lazy(() => import('./sceneEntries/GaramutSepikRamuEntry.jsx')),
});
