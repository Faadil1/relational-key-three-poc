...
Public wrapper `families/signal-nigeria/index.html` promotion source commit:
`95a009e0ca91f8c1de2bfece4ae5ae001ac061d6`.

Direct/public access resolves to validated EXP-3; nested EXP-3 baseline remains non-recursive. Shared runtime unchanged. No semantic change to validated NITEL candidate.

# BLOCKER

Vercel promotion build for `95a009e...` returned **FAILURE — build-rate-limit / Hobby plan**.
