...
LIVE promotion: Vercel Hobby `build-rate-limit`; no application failure inferred. No new USER proof required.
Shared runtime unchanged.

# EXACT NEXT ACTION
1. retry/check Vercel only; do not change Frida semantics;
2. require READY deployment containing promotion commit or descendant;
3. verify public `/families/frida-coyoacan/` resolves to `r5-11.html`;
