...
Experiential matrix: STRONG 13 / ADEQUATE 9 / EXPERIENCE DEBT 2 — Signal / Nigeria, Frida / Coyoacán.

City and Service are CLOSED / ADEQUATE.

# SERVICE / BENIN — CLOSED ✅

Validated EXP-2C USER proof: ~11.97 s / 1920×966 / 30 fps / 359 frames.
...
Baseline signal mechanics are relationally valid but generic.

Documented NITEL anchors:
- Nigerian Telecommunications Limited / NITEL;
- 1990s chip phonecards;
- 100 / 200 / 300 UNITS;
- globe + earth-station dish + transmission mast imagery;
- `NITEL …Your link to the world` phonecard language.
...
Card A: NITEL-derived Earth Station object / 100 UNITS / chip / globe / dish.
Card B: NITEL-derived Transmission Relay object / 300 UNITS / chip / globe / mast.

MATCHING: pair-spanning signal arc + member-edge pulses; center subordinate.
OTHER: two offset residual signal fragments; both signal objects stay valid.
...
Public Signal wrapper remains unchanged pending USER PASS.
Shared runtime unchanged.

LIVE:
`dpl_Fp4rJsmpRJ1zYz4Ei7abjFr5Kusu` READY.
Exact deployed commit `7529cb83a3ed3cdedb315dce5f40e15f39fff7ec`.
...
- Signal EXPERIENCE DEBT pending proof
- VALIDATED 24 unchanged

# EXACT NEXT USER ACTION

Record Signal EXP-3 only, ~10–15 seconds:
...
If PASS: promote Signal only; preserve shared runtime; reclassify Signal out of Experience Debt; close; then open Frida EXP-4.
If FAIL: revise isolated Signal candidate only.

PR remains Draft / DO NOT MERGE.
Trust branch head over documentation-only commit IDs.